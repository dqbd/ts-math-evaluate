...
\begin{figure}[ht]
  \begin{multicols}{2}
    \begin{enumerate}
      \item \code{START} $\rightarrow$ \code{ADD} \code{.}

      \item \code{ADD} $\rightarrow$ \code{MUL} \code{ADDx} \code{.}
      \item \code{ADDx} $\rightarrow$ \mintinline{TypeScript}{"+"} \code{MUL} \code{ADDx} \code{.}
      \item \code{ADDx} $\rightarrow$ \mintinline{TypeScript}{"-"} \code{MUL} \code{ADDx} \code{.}
      \item \code{ADDx} $\rightarrow$ \code{.}

      \item \code{MUL} $\rightarrow$ \code{FACT} \code{MULx} \code{.}
      \item \code{MULx} $\rightarrow$ \mintinline{TypeScript}{"*"} \code{FACT} \code{MULx} \code{.}
      \item \code{MULx} $\rightarrow$ \mintinline{TypeScript}{"/"} \code{FACT} \code{MULx} \code{.}
      \item \code{MULx} $\rightarrow$ \mintinline{TypeScript}{"%"} \code{FACT} \code{MULx} \code{.}

      \item \code{FACT} $\rightarrow$ \code{UNARY} \code{FACTx} \code{.}
      \item \code{FACTx} $\rightarrow$ \mintinline{TypeScript}{"!"} \code{FACTx} \code{.}
      \item \code{FACTx} $\rightarrow$ \code{.}

      \item \code{UNARY} $\rightarrow$ \mintinline{TypeScript}{"-"} \code{UNARY} \code{.}
      \item \code{UNARY} $\rightarrow$ \mintinline{TypeScript}{"+"} \code{UNARY} \code{.}
      \item \code{UNARY} $\rightarrow$ \code{POW} \code{.}

      \item \code{POW} $\rightarrow$ \code{TERM} \code{POWx} \code{.}
      \item \code{POWx} $\rightarrow$ \mintinline{TypeScript}{"^"} \code{POW} \code{.}
      \item \code{POWx} $\rightarrow$ \code{.}

      \item \code{TERM} $\rightarrow$ \mintinline{TypeScript}{"unary"} \mintinline{TypeScript}{"("} \code{ADD} \mintinline{TypeScript}{")"} \code{.}
      \item \code{TERM} $\rightarrow$ \mintinline{TypeScript}{"binary"} \mintinline{TypeScript}{"("} \code{ADD} \code{,} \code{ADD} \mintinline{TypeScript}{")"} \code{.}
      \item \code{TERM} $\rightarrow$ \mintinline{TypeScript}{"("} \code{ADD} \mintinline{TypeScript}{")"} \code{.}
      \item \code{TERM} $\rightarrow$ \mintinline{TypeScript}{"number"} \code{.}
    \end{enumerate}
  \end{multicols}
