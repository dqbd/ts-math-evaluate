...
\ctufitabstractCZE{Tato práce se věnuje tvorbě knihovny pro vyhodnocování matematických výrazů v jazyce TypeScript. Hlavním cílem teto práce je implementace samotných matematických operací a příslušného vyhodnocovače. Tato práce se také zabývá dalšími aspekty implementace: limitace dané typovým systémem, testování korektnosti a měření dopadu knihovny na vývojářské prostředí.}
